...
RSpec.describe "Search for Recipes", type: :request do
  ...
  it "should return a list of recipes when a mix of diet, mealtype, intolerances and ingredients are present", :vcr do
    complex_user_search = "eggs vegetarian breakfast"

    intolerance = "dairy"

    get "/api/v1/search?q=#{complex_user_search}&intolerances=#{intolerance}"
